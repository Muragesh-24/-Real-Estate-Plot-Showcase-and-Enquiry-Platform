...
export const plots: Plot[] = [
  {
    name: "Chennamma Nagar Plot 05",
    location: "Behind Bus Stop, Banahatti",
    size: "30 x 40 ft",
    facing: "East Facing",
    status: "Available",
